--------------------------------------------------------
--  DDL for Function FUNC_CONCEPTE_CALIMA
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SINTAGMA_U"."FUNC_CONCEPTE_CALIMA" (Campo IN VARCHAR2) RETURN VARCHAR2 AS 
AUX VARCHAR2(200);
BEGIN
