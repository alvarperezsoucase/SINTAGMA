--------------------------------------------------------
--  DDL for Function FCN_NORMALITZAR_TFN_CONCEPTO
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SINTAGMA_U"."FCN_NORMALITZAR_TFN_CONCEPTO" (Campo IN VARCHAR2) RETURN VARCHAR2 AS 
    AUX VARCHAR2(50);
BEGIN
...
END FCN_NORMALITZAR_TFN_CONCEPTO;
