--------------------------------------------------------
--  DDL for Table Z_SE999_DM_SUBTIPUS_ACCIO
--------------------------------------------------------

  CREATE TABLE "SINTAGMA_U"."Z_SE999_DM_SUBTIPUS_ACCIO" 
   (	"ID" NUMBER(38,0), 
	"DESCRIPCIO" VARCHAR2(50 BYTE), 
	"USUARI_PER_DEFECTE" VARCHAR2(4000 BYTE), 
	"DATA_CREACIO" DATE, 
