--------------------------------------------------------
--  DDL for Table A0_DM_ESPAI
--------------------------------------------------------

  CREATE TABLE "SINTAGMA_U"."A0_DM_ESPAI" 
   (	"ID" NUMBER(10,0), 
	"DESCRIPCIO" VARCHAR2(50 BYTE), 
	"GRANDARIA" NUMBER(10,0), 
	"AFORAMENT" NUMBER(10,0), 
	"NUMERO_FILES" NUMBER(10,0), 
	"NUMERO_COLUMNES" NUMBER(10,0), 
