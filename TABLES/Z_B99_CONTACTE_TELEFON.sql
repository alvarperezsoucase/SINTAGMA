--------------------------------------------------------
--  DDL for Table Z_B99_CONTACTE_TELEFON
--------------------------------------------------------

  CREATE TABLE "SINTAGMA_U"."Z_B99_CONTACTE_TELEFON" 
   (	"ID" NUMBER(10,0), 
	"NUMERO" VARCHAR2(20 BYTE), 
	"ES_PRINCIPAL" NUMBER(1,0), 
	"OBSERVACIONS" VARCHAR2(50 BYTE), 
	...
	"CONCEPTE" VARCHAR2(50 BYTE), 
	"ES_PRIVAT" NUMBER(1,0)
