--------------------------------------------------------
--  DDL for Package Body B_01_MIGRACIO_VIPS
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."B_01_MIGRACIO_VIPS" AS
   -- CONTACTOS CON CLASIFICACIONES ACTIVAS
    PROCEDURE B01_CONTACTOS_ACTIVOS IS
    BEGIN              
        INSERT INTO Z_B01_CONTACTOS_ACTIVOS (ID_CONTACTE, N_VIP, CARREC, ENTITAT, ADRECA, MUNICIPI)
        SELECT SEQ_CONTACTE.NEXTVAL AS ID_CONTACTE, 
            ...
            WHERE NOT EXISTS (SELECT 1 
                              FROM Z_B01_CONTACTOS_ACTIVOS NUEVOS
   ...
   -- SUJETOS RELACIONADOS CON CONTACTOS.
    ...
    BEGIN
       ...
       INSERT INTO Z_B02_CONTACTOS_VIPS (ID_CONTACTE, N_VIP, ADRECA_P, MUNICIPI_P, TELEFON_P)      
        SELECT SEQ_CONTACTE.NEXTVAL AS ID_CONTACTE, 
               N_VIP, 
        ...
        FROM (
                ...
                WHERE (TRIM(REPLACE(T.ADRECA_P,'.','')) IS NOT NULL 
                  ...
                  AND NOT EXISTS(SELECT 1 
                                 FROM Z_B01_CONTACTOS_ACTIVOS DIF 
         ...
         WHERE NOT EXISTS (SELECT 1 
                              FROM Z_B02_CONTACTOS_VIPS NUEVOS
                              WHERE NUEVOS.N_VIP = T.N_VIP
    ...
    INSERT INTO Z_B04_SUBJECTES_ID --DADES_IDCONTACTES_CLASS_VIPS
      SELECT DIF.Id_Contacte,
      ...
      WHERE DIF.N_VIP = VIPS.N_VIP
        ...
        AND NOT EXISTS (SELECT 1
                        FROM Z_B04_SUBJECTES_ID NUEVOS
                        WHERE NUEVOS.Id_Contacte = DIF.Id_Contacte);
   ...
   PROCEDURE B30_TRACTAMENTS IS 
    ...
    BEGIN
            ...
            INSERT INTO Z_B50_CARRECS (ID_CARREC, CARREC_NORM)
    ...
    BEGIN
             ...
             INSERT INTO Z_B51_CARRECS_CONTACTES_REL (ID_CONTACTE, ID_CARREC)
                    ...
                    WHERE TRIM(FUNC_NORMALITZAR(c.CARREC)) IS NOT NULL 
                      ...
                      AND NOT EXISTS ( SELECT 1 
                      				   FROM Z_B51_CARRECS_CONTACTES_REL ANTIGUOS
    ...
    BEGIN
        INSERT INTO Z_B52_CARRECS_CONTACTES_NULL (ID_CONTACTE, ID_CARREC)
                     SELECT Contacte.ID_CONTACTE AS ID_CONTACTE,
                            NULL AS ID_CARREC
                    FROM Z_B03_CONTACTES_ID Contacte
                    WHERE TRIM(FUNC_NORMALITZAR(Contacte.CARREC)) IS NULL                      
                      AND NOT EXISTS ( SELECT 1 
                      				   FROM Z_B52_CARRECS_CONTACTES_NULL ANTIGUOS
    ...
    BEGIN
        ...
        INSERT INTO Z_B53_CARRECS_CONTACTES (ID_CONTACTE,ID_CARREC)
                    SELECT ID_CONTACTE,
                           ID_CARREC
                    FROM (       
                            SELECT ID_CONTACTE, ID_CARREC
                            FROM Z_B51_CARRECS_CONTACTES_REL
                                UNION ALL
                            SELECT ID_CONTACTE, NULL
                            FROM Z_B52_CARRECS_CONTACTES_NULL
                         ) CARRECS_CONTACTES	
                    WHERE NOT EXISTS (SELECT 1 
                                      FROM Z_B53_CARRECS_CONTACTES ANTIGUOS
    ...
    BEGIN
            ...
            INSERT INTO Z_B60_ENTITAT_CATALOG (ID, CODI, ENTITAT, ENTITAT_NORM)
                 SELECT SEQ_DM_ENTITAT.NEXTVAL, 
                        CODI, 
                        ENTITAT, 
                        ENTITAT_NORM
                   FROM (
...
--                                   ); 
        ...
        BEGIN
                INSERT INTO Z_B61_ENTITATS_CODI_NULL
                            ...
                            WHERE NOT EXISTS(SELECT 1 
                                              FROM Z_B61_ENTITATS_CODI_NULL ANTIGUOS
    ...
    BEGIN    
            ...
            INSERT INTO Z_B66_ENTITATS_CONTACTES (ID, ID_CONTACTE)
                 SELECT ent.id AS ID, 
                        c.id_contacte
                 FROM DM_ENTITAT ent, 
                      Z_B03_CONTACTES_ID c
                WHERE FUNC_NORMALITZAR_ENTITAT(ent.descripcio) = FUNC_NORMALITZAR_ENTITAT(c.entitat) 
                  ...
                  AND  NOT EXISTS(SELECT 1 
                                  FROM Z_B66_ENTITATS_CONTACTES ec 
...
------------------------------------------------------------------------------    
    ...
    BEGIN
           INSERT INTO Z_B71_SUBJECTES_AMB_PRIORITAT    (N_VIP, PRIORITAT)
                SELECT N_VIP, 
    ...
    BEGIN
                ...
                INSERT INTO Z_B72_SUBJECTES_VIPS (ID, NOM,COGNOM1,COGNOM2,ALIES,NOM_NORMALITZAT, DATA_DEFUNCIO,MOTIU_BAIXA,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT,	TRACTAMENT_ID,	PRIORITAT_ID,	TIPUS_SUBJECTE_ID,	AMBIT_ID,	IDIOMA_ID)
                        SELECT ID AS ID, 
                               MAX(NOM) AS NOM, 
                  ...
                  FROM (
                          SELECT  Subjecte.N_VIP AS ID,
                                  ...
                                  NVL(USU_ALTA, 'MIGRACIO') AS USUARI_CREACIO,   
                                  ...
                                  (SELECT tractament.ID FROM DM_TRACTAMENT tractament WHERE tractament.ID = Subjecte.Tractament) AS TRACTAMENT_ID,
                                  ...
                                  NULL AS IDIOMA_ID         
                          FROM Z_B04_SUBJECTES_ID Subjecte, 
                               Z_B70_SUBJECTES_DIFUNTS SubjecteDifunto, 
                               Z_B71_SUBJECTES_AMB_PRIORITAT SubjectePR
    ...
    INSERT INTO Z_B73_SUBJECTE_CONTACTE (ID, NOM,COGNOM1,COGNOM2,ALIES,NOM_NORMALITZAT,DATA_DEFUNCIO,MOTIU_BAIXA,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,	USUARI_MODIFICACIO,	USUARI_ESBORRAT, TRACTAMENT_ID,	PRIORITAT_ID, TIPUS_SUBJECTE_ID, AMBIT_ID, IDIOMA_ID)
                SELECT ID as ID, 
                       MAX(NOM) AS NOM, 
                       MAX(COGNOM1) AS COGNOM1, 
                       MAX(COGNOM2) AS COGNOM2, 
                ...
                FROM (
                          SELECT  Contactes.N_VIP AS ID,
                                  ...
                                  NVL(Contactes.USU_ALTA, 'MIGRACIO') AS USUARI_CREACIO,   
                                  ...
                                  (SELECT Tractament.ID FROM DM_TRACTAMENT Tractament WHERE Tractament.ID = VIPS.TRACTAMENT ) AS TRACTAMENT_ID, 
                                  (SELECT Prioritat.ID FROM DM_PRIORITAT Prioritat WHERE Prioritat.DESCRIPCIO = SubjectePR.prioritat) AS PRIORITAT_ID,
                                  ConstSubjectePersona AS TIPUS_SUBJECTE_ID,
                                  ConstAMBIT_PROTOCOL AS AMBIT_ID,
                                  NULL AS IDIOMA_ID 
                          FROM Z_B03_CONTACTES_ID Contactes, 
                               Z_B70_SUBJECTES_DIFUNTS SubjecteDifunt, 
                               Z_B71_SUBJECTES_AMB_PRIORITAT SubjectePR, 
                               Z_TMP_VIPS_U_VIPS VIPS
    ...
    BEGIN
      ...
      INSERT INTO SUBJECTE (ID, NOM, COGNOM1, COGNOM2, ALIES, DATA_DEFUNCIO, NOM_NORMALITZAT, MOTIU_BAIXA, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, TRACTAMENT_ID, PRIORITAT_ID, TIPUS_SUBJECTE_ID, AMBIT_ID, IDIOMA_ID)
                SELECT  ID AS ID,
                        NOM AS NOM,
                        COGNOM1 AS COGNOM1,
                        COGNOM2 AS COGNOM2,
                        ...
                        NULL AS IDIOMA_ID
                FROM Z_B72_SUBJECTES_VIPS NUEVOS
                WHERE NOT EXISTS (SELECT 1
                                   FROM SUBJECTE ANTIGUOS
       ...
       COMMIT;                                 
        ...
        INSERT INTO SUBJECTE (ID, NOM, COGNOM1, COGNOM2, ALIES, DATA_DEFUNCIO, NOM_NORMALITZAT, MOTIU_BAIXA, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, TRACTAMENT_ID, PRIORITAT_ID, TIPUS_SUBJECTE_ID, AMBIT_ID, IDIOMA_ID, ARTICLE_ID)
                SELECT  ID AS ID,
                        NOM AS NOM,
                        COGNOM1 AS COGNOM1,
                        COGNOM2 AS COGNOM2,
                        ...
                        NULL AS IDIOMA_ID,
                        1 AS ARTICLE_ID
                FROM Z_B73_SUBJECTE_CONTACTE NUEVOS
                WHERE NOT EXISTS (SELECT 1
                                   FROM SUBJECTE ANTIGUOS
                                  WHERE  ANTIGUOS.ID = NUEVOS.ID
                                 );     
    ...
    -----------------------------------------------------------------------------------        
      ...
      BEGIN
              INSERT INTO Z_B80_ADRECA_CONTACTE (ID_ADRECA,ID_CONTACTE,ADRECA,MUNICIPI,CP,PROVINCIA,PAIS,USU_ALTA,DATA_ALTA,USU_MODIF,DATA_MODIF)
                    SELECT SEQ_ADRECA.NEXTVAL AS ID_ADRECA, 
                           ...
                           USU_MODI AS USU_MODIF, 
                           DATA_MODI AS DATA_MODIF
                   FROM (
                           SELECT Contactes.ID_CONTACTE, 
                               ...
                               MAX(t.PAIS) AS PAIS, 
                               MAX(NVL(Contactes.USU_ALTA,'MIGRACIO')) AS USU_ALTA, 
                               MAX(NVL(Contactes.DATA_ALTA,TO_DATE('01/01/1970','dd/mm/yyyy'))) AS DATA_ALTA, 
    ...
    BEGIN
              ...
              INSERT INTO Z_B81_ADRECA_SUBJECTE (ID_ADRECA,ID_CONTACTE,ADRECA,MUNICIPI,CP,PROVINCIA,PAIS,USU_ALTA,DATA_ALTA,USU_MODIF,DATA_MODIF)
                    SELECT SEQ_ADRECA.NEXTVAL AS ID_ADRECA, 
                           ...
                           NVL(Subjecte.USU_ALTA,'MIGRACIO') AS USU_ALTA, 
     ...
     PROCEDURE B81_ADRECA IS
     BEGIN
              INSERT INTO ADRECA (ID, NOM_CARRER, MUNICIPI, PROVINCIA, CODI_POSTAL, PAIS, USUARI_CREACIO, DATA_CREACIO, USUARI_MODIFICACIO,DATA_MODIFICACIO)
...
--                AND TO_NUMBER(SUBSTR(PAIS,1,1)) IN (0,1,2,3) AND TRIM(PAIS)<>'.'
    ...
    BEGIN
        ...
        INSERT INTO Z_B93_CONTACTES_CONTACTES (ID, ES_PRINCIPAL, CARREC_ID, DEPARTAMENT, DADES_QUALITAT, DATA_DARRERA_ACTUALITZACIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TIPUS_CONTACTE_ID, SUBJECTE_ID, ADRECA_ID, ENTITAT_ID,VISIBILITAT_ID, AMBIT_ID)
                ...
                FROM (
                        SELECT Contacto.ID_CONTACTE, 
                               ...
                               ConstAMBIT_PROTOCOL AS AMBIT_ID
                        FROM  Z_B80_ADRECA_CONTACTE Adreca, 
                              Z_B90_CONTACTES_PRINCIPALS Contate_Principals, 
                              Z_B91_DATA_ACT_CONTACTE Contacte_act, 
                              Z_B53_CARRECS_CONTACTES Carrecs, 
                              Z_B66_ENTITATS_CONTACTES Entitats, 
                              SUBJECTE Subjecte, 
                             (
                                SELECT ID_CONTACTE, 
                        ...
                        WHERE Contacto.n_vip = Subjecte.id 
                          ...
                          AND NOT EXISTS (SELECT 1 
                                          FROM Z_B93_CONTACTES_CONTACTES nuevos 
       ...
       BEGIN 
        ...
        INSERT INTO Z_B94_CONTACTES_SUBJECTES (ID, ES_PRINCIPAL, CARREC_ID, DEPARTAMENT, DADES_QUALITAT, DATA_DARRERA_ACTUALITZACIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TIPUS_CONTACTE_ID, SUBJECTE_ID, ADRECA_ID, ENTITAT_ID,VISIBILITAT_ID, AMBIT_ID)
            SELECT ID_CONTACTE AS ID,
                        MAX(PRINCIPAL) AS ES_PRINCIPAL, 
                        MAX(ID_CARREC) AS CARREC_ID, 
                        MAX(DEPART) AS DEPARTAMENT, 
          ...
          FROM (
                    ...
                    WHERE Subjecte.n_vip = s.id 
                      ...
                      AND NOT EXISTS (SELECT 1 
                                        FROM Z_B94_CONTACTES_SUBJECTES nuevos 
    ...
    BEGIN
       ...
       INSERT INTO CONTACTE (ID, ES_PRINCIPAL, CARREC_ID, DEPARTAMENT, DADES_QUALITAT, DATA_DARRERA_ACTUALITZACIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TIPUS_CONTACTE_ID, SUBJECTE_ID, ADRECA_ID, ENTITAT_ID,VISIBILITAT_ID, AMBIT_ID) 
          SELECT ID, ES_PRINCIPAL, CARREC_ID, DEPARTAMENT, DADES_QUALITAT, DATA_DARRERA_ACTUALITZACIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TIPUS_CONTACTE_ID, SUBJECTE_ID, ADRECA_ID, ENTITAT_ID,VISIBILITAT_ID, AMBIT_ID
          FROM (       
                 SELECT ID AS ID,
                        ...
                        AMBIT_ID AS AMBIT_ID
                FROM Z_B93_CONTACTES_CONTACTES 
                 where exists (select 1 from adreca adreca where adreca.id = ADRECA_ID)
                 and exists (select 1 from dm_entitat entitat where entitat.id = ENTITAT_ID)
                    UNION ALL
                 SELECT ID AS ID,
                        ES_PRINCIPAL AS ES_PRINCIPAL,
                        CARREC_ID AS CARREC_ID,
                        ...
                        VISIBILITAT_ID AS VISIBILITAT_ID,
                        AMBIT_ID AS AMBIT_ID
                FROM Z_B94_CONTACTES_SUBJECTES 
                where exists (select 1 from adreca adreca where adreca.id = ADRECA_ID)
                 and exists (select 1 from dm_entitat entitat where entitat.id = ENTITAT_ID)
           );
        ...
        BEGIN
            ...
            INSERT INTO CONTACTE_CORREU(ID, CORREU_ELECTRONIC, ES_PRINCIPAL, DATA_CREACIO, USUARI_CREACIO, Contacte_Id)
                    SELECT SEQ_CONTACTE_CORREU.NEXTVAL AS ID, 
                     ...
                     and exists (select 1 from contacte where Id = cc.id_contacte);                                        
            COMMIT;
                       ...
                       SELECT SEQ_ACOMPANYANT.NEXTVAL AS ID, 
                        ...
                        WHERE ase.n_vip = B3.n_vip 
                          AND EXISTS (SELECT * 
                           ...
                           and exists (select 1 from contacte where Id = b3.id_contacte);     
--                          AND NOT EXISTS (SELECT 1 
...
--                                         )
    ...
    BEGIN
         ...
         DELETE FROM Z_B66_ENTITATS_CONTACTES;    
         DELETE FROM Z_B61_ENTITATS_CODI_NULL;  
         DELETE FROM Z_B60_ENTITAT_CATALOG;
         
         DELETE FROM DM_CARREC;
         
         DELETE FROM Z_B53_CARRECS_CONTACTES;
         DELETE FROM Z_B52_CARRECS_CONTACTES_NULL;
         DELETE FROM Z_B51_CARRECS_CONTACTES_REL;
         ...
         DELETE FROM Z_B04_SUBJECTES_ID;
         DELETE FROM Z_B03_CONTACTES_ID;
         DELETE FROM Z_B02_CONTACTOS_VIPS;   
         DELETE FROM Z_B01_CONTACTOS_ACTIVOS;
