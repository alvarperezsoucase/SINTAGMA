--------------------------------------------------------
--  DDL for Package Body A_04_RISPLUS_TEMAS_SINTAGMA
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."A_04_RISPLUS_TEMAS_SINTAGMA" AS
...
BEGIN
    ...
    COMMIT;
                INSERT INTO DM_LLOC (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, AMBIT_ID, USUARI_ESBORRAT,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                      SELECT ID, 
                       		  DESCRIPCIO, 
...
BEGIN
         ...
         INSERT INTO Z_E999_DM_DISTRICTE (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
            ...
            /*hay que quitar las constrains de err */
                    INSERT INTO DM_DISTRICTE (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                               SELECT ID, 
                                      DESCRIPCIO, 
                                      FUNC_NULOS_DATE(DATA_CREACIO) AS DATA_CREACIO, 
                                      FUNC_NULOS_DATE(DATA_MODIFICACIO) AS DATA_MODIFICACIO, 
...
BEGIN
    ...
    INSERT INTO Z_E999_DM_TIPUS_TEMA (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
             SELECT SEQ_DM_TIPUS_TEMA.NEXTVAL AS ID,
        ...
        COMMIT;                                  
         ...
         INSERT INTO DM_TIPUS_TEMA (ID, CODI, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                               SELECT ID, 
                                      ID AS CODI,
...
BEGIN
        INSERT INTO DM_ESPECIFIC (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
               SELECT SEQ_DM_ESPECIFIC.NEXTVAL AS ID, 
                      DESCRIPCIO, 
                      DATA_CREACIO, 
                      DATA_MODIFICACIO, 
                      DATA_ESBORRAT, 
...
BEGIN
     INSERT INTO Z_E020_TIPUSACCIO_DMTIPUSACCIO (ID, ACCIO_ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
            SELECT SEQ_DM_TIPUS_ACCIO.NEXTVAL AS ID,
...
BEGIN
        ...
        INSERT INTO DM_TIPUS_ACCIO (ID,DESCRIPCIO,DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                  SELECT ID,            
                         DESCRIPCIO,
                         DATA_CREACIO, 
                         DATA_MODIFICACIO, 
...
COMMIT;
 ...
 COMMIT;                                  
            INSERT INTO DM_SUBTIPUS_ACCIO (ID, DESCRIPCIO, USUARI_PER_DEFECTE,DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID, TIPUS_ACCIO_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                 SELECT ID, 
                 		DESCRIPCIO, 
                        USUARI_PER_DEFECTE AS USUARI_PER_DEFECTE,
                 		DATA_CREACIO, 
                 ...
                 WHERE NOT EXISTS  (SELECT 1 
                                      FROM DM_SUBTIPUS_ACCIO ANTIGUOS
                                     WHERE  ANTIGUOS.ID = NUEVOS.ID 
                                       AND ANTIGUOS.TIPUS_ACCIO_ID = NUEVOS.TIPUS_ACCIO_ID  
                                       AND ANTIGUOS.INSTALACIOID = NUEVOS.INSTALACIOID
                                   );                
...
BEGIN
            ...
            COMMIT;
                    ...
                    INSERT INTO DM_DESTI_DELEGACIO (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARIO_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                               SELECT ID, 
                                      DESCRIPCIO, 
                                      DATA_CREACIO, 
                                      DATA_MODIFICACIO, 
                                ...
                                WHERE NOT EXISTS  (SELECT 1 
                                                     FROM DM_DESTI_DELEGACIO ANTIGUOS
                                                    WHERE ANTIGUOS.ID = NUEVOS.ID
                                                     AND ANTIGUOS.AMBIT_ID = NUEVOS.AMBIT_ID
                                                   );                 
 ...
 */          
     ...
     INSERT INTO Z_E999_DM_TIPUS_ELEMENT (ID, DESCRIPCIO,  DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                 SELECT SEQ_DM_TIPUS_ELEMENT.NEXTVAL AS ID, 
                        DESCRIPCIO, 
                        DATA_CREACIO, 
                        DATA_MODIFICACIO, 
                        DATA_ESBORRAT, 
        ...
        COMMIT;    
        INSERT INTO DM_TIPUS_ELEMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                   SELECT ID, 
                          DESCRIPCIO, 
                          DATA_CREACIO, 
                          DATA_MODIFICACIO, 
                    ...
                    WHERE NOT EXISTS  (SELECT 1 
                                         FROM DM_TIPUS_ELEMENT ANTIGUOS
                                        WHERE ANTIGUOS.ID = NUEVOS.ID
                                         AND ANTIGUOS.AMBIT_ID = NUEVOS.AMBIT_ID                                         
                                       );     
...
--                                                  WHERE  ANTIGUOS.ID = NUEVOS.ID 
        ...
        INSERT INTO DM_DECISIO_AGENDA (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARIO_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                               SELECT ID, 
                                      DESCRIPCIO, 
                                      DATA_CREACIO, 
                                      DATA_MODIFICACIO, 
                                ...
                                WHERE NOT EXISTS  (SELECT 1 
                                                     FROM DM_DECISIO_AGENDA ANTIGUOS
                                                    WHERE ANTIGUOS.ID = NUEVOS.ID
                                                     AND ANTIGUOS.AMBIT_ID = NUEVOS.AMBIT_ID
                                                   );                 
...
BEGIN
       ...
       INSERT INTO Z_E999_DM_PRIORITAT_ELEMENT (ID, PRIORITATID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                                    SELECT SEQ_DM_PRIORITAT_ELEMENT.NEXTVAL AS ID,
        ...
        INSERT INTO DM_PRIORITAT_ELEMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARIO_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                               SELECT ID, 
                                      DESCRIPCIO, 
                                      DATA_CREACIO, 
                                      DATA_MODIFICACIO, 
                                ...
                                WHERE NOT EXISTS  (SELECT 1 
                                                     FROM DM_PRIORITAT_ELEMENT ANTIGUOS
                                                    WHERE ANTIGUOS.ID = NUEVOS.ID                                                     
                                                   );                 
...
BEGIN
     ...
     INSERT INTO Z_E999_DM_PREFIX_ANY (ID, DESCRIPCIO,CONTADOR, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
        ...
        INSERT INTO DM_PREFIX_ANY (ID, DESCRIPCIO,CONTADOR, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
             SELECT ID, 
                    DESCRIPCIO, 
                    CONTADOR,
                    DATA_CREACIO, 
     ...
     INSERT INTO Z_E999_DM_TIPUS_SUPORT (ID, CODI, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
         ...
         FROM (     
           ...
           COMMIT;
            ...
            INSERT INTO DM_TIPUS_SUPORT (ID, CODI, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                                 SELECT ID, 
                                        CODI,
                                        DESCRIPCIO, 
                                        DATA_CREACIO, 
...
BEGIN
   ...
   INSERT INTO Z_E040_SERIES_SUBSERIES (ID, SERIEID, SUBSERIEID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
              SELECT SEQ_SERIE_SUBSERIE.NEXTVAL AS ID, 
                     SERIEID, 
                     SUBSERIEID, 
                     DESCRIPCIO, 
                     DATA_CREACIO, 
...
BEGIN
      ...
      INSERT INTO DM_SERIE (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                  SELECT ID, 
--                         SERIEID,
--                         SUBSERIEID,
                         DESCRIPCIO,
...
BEGIN
     ...
     INSERT INTO Z_E042_DM_CATALEG_DOCUMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
      ...
      INSERT INTO DM_CATALEG_DOCUMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
               SELECT *
                 FROM Z_E042_DM_CATALEG_DOCUMENT NUEVOS 
                WHERE NOT EXISTS (SELECT *
                                    FROM DM_CATALEG_DOCUMENT ANTIGUOS
                                   WHERE ANTIGUOS.ID = NUEVOS.ID
                                 ) ;
      ...
      INSERT INTO Z_E043_DM_PREFIX (ID, DESCRIPCIO, CONTADOR,DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
         SELECT ID AS ID, 
          ...
          WHERE NOT EXISTS (SELECT 1
           ...
           INSERT INTO DM_PREFIX (ID, DESCRIPCIO, CONTADOR,DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
              SELECT *
                FROM Z_E043_DM_PREFIX NUEVOS
               WHERE NOT EXISTS (SELECT *
                                   FROM DM_PREFIX ANTIGUOS
                                  WHERE ANTIGUOS.ID = NUEVOS.ID
                                    AND ANTIGUOS.INSTALACIOID = NUEVOS.INSTALACIOID
                                 );
...
BEGIN
        ...
        INSERT INTO Z_E999_DM_ESTAT_ELEMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO,AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
             SELECT SEQ_DM_ESTAT_ELEMENT.NEXTVAL AS ID, 
                    DESCRIPCIO, 
                    DATA_CREACIO, 
                    DATA_ESBORRAT, 
                    DATA_MODIFICACIO, 
            ...
            INSERT INTO DM_ESTAT_ELEMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO,AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                SELECT ID, 
                    DESCRIPCIO, 
                    DATA_CREACIO, 
                    DATA_ESBORRAT, 
              ...
              WHERE NOT EXISTS (SELECT 1
                                  FROM DM_ESTAT_ELEMENT ANTIGUOS
                                 WHERE ANTIGUOS.ID = NUEVOS.ID 
                                   AND ANTIGUOS.AMBIT_ID = NUEVOS.AMBIT_ID 
                               );  
...
BEGIN
     ...
     INSERT INTO Z_E061_DM_PAS_ACCIO (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID, TIPUS_ACCIO,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
            SELECT  SEQ_DM_PAS_ACCIO.NEXTVAL AS  ID, 
                    DESCRIPCIO, 
                    DATA_CREACIO, 
                    DATA_MODIFICACIO, 
                    DATA_ESBORRAT, 
      ...
      COMMIT;
             ...
             INSERT INTO DM_PAS_ACCIO (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, AMBIT_ID, TIPUS_ACCIO, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,INSTALACIOID)
                         SELECT ID, 
                                DESCRIPCIO, 
                                DATA_CREACIO, 
                                DATA_MODIFICACIO, 
...
BEGIN
        ...
        INSERT INTO Z_E999_DM_TIPUS_AGENDA (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO,AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,INSTALACIOID)
             SELECT SEQ_DM_TIPUS_AGENDA.NEXTVAL AS ID, 
                    DESCRIPCIO, 
                    DATA_CREACIO, 
                    DATA_ESBORRAT, 
                    DATA_MODIFICACIO, 
...
BEGIN
          ...
          INSERT INTO Z_E999_DM_ORIGEN_ELEMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO,AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,INSTALACIOID)
             SELECT SEQ_DM_ORIGEN_ELEMENT.NEXTVAL as  ID, 
                    DESCRIPCIO, 
                    DATA_CREACIO, 
                    DATA_ESBORRAT, 
                    DATA_MODIFICACIO, 
           ...
           INSERT INTO DM_ORIGEN_ELEMENT 
                    SELECT * 
                      FROM Z_E999_DM_ORIGEN_ELEMENT NUEVOS
                     WHERE NOT EXISTS (SELECT 1
                                         FROM DM_ORIGEN_ELEMENT ANTIGUOS
                                        WHERE ANTIGUOS.ID = NUEVOS.ID
                                          AND ANTIGUOS.AMBIT_ID = NUEVOS.AMBIT_ID
                                       );
...
BEGIN
    ...
    INSERT INTO Z_E999_DM_TIPUS_ARG (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO,AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,INSTALACIOID)
           ...
           INSERT INTO DM_TIPUS_ARG 
                    SELECT * 
                      FROM Z_E999_DM_TIPUS_ARG NUEVOS
                     WHERE NOT EXISTS (SELECT 1
                                         FROM DM_TIPUS_ARG ANTIGUOS
                                        WHERE ANTIGUOS.ID = NUEVOS.ID
                                          AND ANTIGUOS.AMBIT_ID = NUEVOS.AMBIT_ID
                                       );
...
BEGIN
        ...
        INSERT INTO Z_E999_DM_TIPUS_DATA (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO,AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,INSTALACIOID)
             SELECT SEQ_DM_TIPUS_DATA.NEXTVAL AS ID, 
                    DESCRIPCIO, 
                    DATA_CREACIO, 
                    DATA_ESBORRAT, 
                    DATA_MODIFICACIO, 
...
*/
            ...
            INSERT INTO ASPECTE (ID, DESCRIPCIO, DATA_ASSENTAMENT, USUARI_ASSENTAMENT, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TIPUS_TEMA_ID, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                      SELECT ASP.aspecteid AS id,
                             ...
                             FUNC_NULOS_STRING() AS USUARI_MODIFICACIO,
                             FUNC_NULOS_STRING() AS USUARI_ESBORRAT,
                             (SELECT ID FROM DM_TIPUS_TEMA TEMA WHERE TEMA.DESCRIPCIO = ASP.TIPUS AND TEMA.INSTALACIOID =  ConstInstalacio) AS TIPUS_TEMA_ID,
                             ConstAMBIT_ALCALDIA AS AMBIT_ID,
...
BEGIN
              INSERT INTO DOSSIER (ID, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, PREFIX_ANY_ID, ASPECTE_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                   SELECT SEQ_DOSSIER.NEXTVAL AS ID, 
                          DATA_CREACIO, 
                          DATA_MODIFICACIO, 
                          DATA_ESBORRAT, 
                          USUARI_CREACIO, 
...
BEGIN
    ...
    INSERT INTO Z_E130_TITULARDINS (ID, ASPECTE_ID, USUARI_ID, NOM_USUARI, MATRICULA_USUARI, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
	        SELECT SEQ_TITULAR_DINS.NEXTVAL AS ID, 
				   ASPECTE_ID,
				   USUARI_ID,
				   NOM_USUARI,
				   MATRICULA_USUARI,
...
BEGIN
    ...
    INSERT INTO TITULAR_DINS (ID, NOM_USUARI, MATRICULA_USUARI, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, ASPECTE_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
            SELECT ID, 
                   NOM_USUARI, 
                   MATRICULA_USUARI,
                   DATA_CREACIO, 
...
BEGIN
   ...
   INSERT INTO Z_E140_ELEMPRINCIPAL_REGISTRE 
            SELECT ELEMENT_PPAL_ID,
                   SEQ_REGISTRE.NEXTVAL AS REGISTRE_ID
             FROM (      
...
BEGIN
    ...
    INSERT INTO REGISTRE (ID, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,INSTALACIOID)
             ...
             SELECT ID,
              ...
              FROM (      
                     SELECT EP.ASPECTEID AS ID,	
                       ...
                       (SELECT NOM_USUARI FROM TITULAR_DINS WHERE ID = EL.TITULARDINSID AND ASPECTE_ID = el.ASPECTEID) AS NOM_USUARI_RESPONSABLE,
                       (SELECT MATRICULA_USUARI FROM TITULAR_DINS WHERE ID = EL.TITULARDINSID AND ASPECTE_ID = el.ASPECTEID) AS MATRICULA_USUARI_RESPONSABLE,
                       ...
                       (CASE WHEN EL.ESENTRADA = 1 THEN 
                        ...
                        (SELECT ID FROM DOSSIER WHERE ASPECTE_ID = EP.DOSSIERID) AS DOSSIER_ID,
                 ...
                 WHERE NOT EXISTS (SELECT 1 
                                     FROM ELEMENT_PRINCIPAL ANTIGUOS
...
BEGIN
            INSERT INTO ELEMENT_SECUNDARI (ID, NUMERO_REGISTRE, ES_RELACIO_ENTRADA, DATA_RELACIO_ENTRADA, ES_VALIDAT_RE, DATA_REGISTRE_GENERAL, DATA_DOCUMENT, COMENTARIS, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, ASPECTE_ID, ELEMENT_PRINCIPAL_ID, TIPUS_SUPORT_ID, ORIGEN_ID, PREFIX_ID, NUMERO_REGISTRE_GENERAL_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
              SELECT ID,
                     NUMERO_REGISTRE,
                     ES_RELACIO_ENTRADA,
                     DATA_RELACIO_ENTRADA,
              ...
              FROM (    
                    ...
                    WHERE NOT EXISTS (SELECT 1 
                                        FROM ELEMENT_SECUNDARI ANTIGUOS
                                       WHERE  ANTIGUOS.ID = ELEMENTS_SEUNDARIOS.ID
                                     )
                      AND EXISTS(SELECT 1
                     			  FROM ELEMENT_PRINCIPAL ELEM_PPAL
...
BEGIN
                   ...
                   INSERT INTO ENTRADA_AGENDA (ID, LLOC_BIS, DATA_INICI_ACTE, DATA_FI_ACTE, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, ACOMPANYANT, VALORACIO, ASSISTENTS, ES_AFECTA_PROTOCOL, ES_DECISIO, ELEMENT_PRINCIPAL_ID, DECISIO_AGENDA_ID, TIPUS_AGENDA_ID, LLOC_ID, TIPUS_DATA_ID, DISTRICTE_ID, BARRI_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
                       SELECT FITXAAGENDAID AS ID,
                              ...
                              NULL AS ES_DECISIO,
                              (SELECT ID FROM ELEMENT_PRINCIPAL EP WHERE EP.ASPECTE_ID = ASPECTE_ID AND ROWNUM=1) AS ELEMENT_PRINCIPAL_ID,
                              DECISIOID AS DECISIO_AGENDA_ID,
                              (SELECT ID FROM DM_TIPUS_AGENDA TIP_AG WHERE TIP_AG.DESCRIPCIO = 'CONCRETA' AND AMBIT_ID=1) AS TIPUS_AGENDA_ID,
                              LLOCID AS LLOC_ID,
                              (SELECT ID FROM DM_TIPUS_DATA TIP_DAT WHERE TIP_DAT.DESCRIPCIO = 'CONCRETA' AND AMBIT_ID=1) AS TIPUS_DATA_ID,
...
BEGIN
        ...
        INSERT INTO AGENDA_DELEGACIO (ID, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, DESTI_DELEGACIO_ID, ENTRADA_AGENDA_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID) 
                       SELECT SEQ_AGENDA_DELEGACIO.NEXTVAL AS ID, 
                      		  SYSDATE AS DATA_CREACIO,
                              FUNC_NULOS_DATE(NULL) AS DATA_MODIFICACIO,
                              FUNC_NULOS_DATE(NULL) AS DATA_ESBORRAT,
                              FUNC_USU_CREACIO(NULL) AS USUARI_CREACIO,
...
BEGIN
        ...
        INSERT INTO CLASSIFICACIO_ARXIU (ID, DESCRIPTORS_TEMATICS, DATA_TRANSFERENCIA, DATA_ARXIU, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, SERIE_ID, ESPECIFIC_ID, ASPECTE_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL, INSTALACIOID)
            SELECT ID, 
            ...
            FROM (   
                 ...
                 WHERE NOT EXISTS (SELECT 1
                          FROM CLASSIFICACIO_ARXIU ANTIGUOS
                         WHERE ANTIGUOS.ID = NUEVOS.ID
                       );  
...
END A_04_RISPLUS_TEMAS_SINTAGMA;
