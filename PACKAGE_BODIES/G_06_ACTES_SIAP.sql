--------------------------------------------------------
--  DDL for Package Body G_06_ACTES_SIAP
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."G_06_ACTES_SIAP" AS
  ...
  */
  ...
  BEGIN
              ...
              INSERT INTO Z_G002_NUEVOS_CLASIFFICACIO (ID_SINTAGMA, ID_SIAP, SIAP_CODI, SIAP_CLASSIFICACIO, SIAP_OBSOLET)
                        SELECT (20000 + AUX_SEQ_SIAP_CLASSIFICACIO.NEXTVAL) AS ID_SINTAGMA,
  ...
  BEGIN
    ...
    COMMIT;
      ...
      --SE INSERTAN LOS NUEVOS EN CATALOGI
             INSERT INTO DM_CLASSIFICACIO (ID, DESCRIPCIO, CODI, PRELACIO, DATA_INICI_REVISO, DATA_FI_REVISIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, TIPOLOGIA_ID, AMBIT_ID)
  ...
  BEGIN
        ...
        INSERT INTO Z_G024_DM_TIPUS_ACTE (ID, CODI, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)
            ...
            INSERT INTO DM_TIPUS_ACTE (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)
                SELECT ID, 
                       DESCRIPCIO, 
                       DATA_CREACIO, 
                       DATA_ESBORRAT, 
  ...
  BEGIN
        ...
        INSERT INTO DM_SECTOR (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)
            SELECT ID,
  ...
  END;
   ...
   BEGIN
    ...
    INSERT INTO DM_CATEGORIA (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)
             SELECT ID,
...
*/
  ...
  BEGIN
    ...
    INSERT INTO DM_PRESIDENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)
                 SELECT ID,
  ...
  BEGIN
     ...
     INSERT INTO DM_PETICIONARI (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)
                 SELECT ID,
  ...
  BEGIN
            ...
            INSERT INTO Z_G045_ESTAT_ACTE (ID,DESCRIPCIO)
                        SELECT AUX_SEQ_SIAP_DM_ESTAT_ACTE.NEXTVAL AS ID,
        ...
        INSERT INTO DM_ESTAT_ACTE (ID, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)         
                 SELECT ID AS ID, 
                        DESCRIPCIO AS DESCRIPCIO, 
                        SYSDATE AS DATA_CREACIO, 
                        NULL AS DATA_ESBORRAT, 
  ...
  END;
   ...
   BEGIN
        ...
        */
        --DESDE SIAP 
        INSERT INTO ACTE (ID, TITOL, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, DATA_ENTRADA, COMENTARIS_VALORACIO, ELEMENT_PRINCIPAL_ID, TIPUS_ACTE_ID, CATEGORIA_ID, SECTOR_ID, PRESIDENT_ID, PETICIONARI_ID, ESTAT_ACTE_ID, ESTAT_GESTIO_INVITACIO_ID, ESTAT_GESTIO_ESPAIS_ID)
                                SELECT ID AS ID,
                                       ...
                                       1 AS ELEMENT_PRINCIPAL_ID,
                                       IDTIPUS_ACTE AS TIPUS_ACTE_ID,
                                       FUNC_ALEATORIO(21)  AS CATEGORIA_ID, --OJO TEMPORAL. NO PERMITE NULOS
                                       FUNC_ALEATORIO(27) AS SECTOR_ID,
                                       FUNC_ALEATORIO(82) AS PRESIDENT_ID,
                                       FUNC_ALEATORIO(147) AS PETICIONARI_ID,
                                       FUNC_ALEATORIO(4) AS ESTAT_ACTE_ID,
                                       FUNC_ALEATORIO(3) AS ESTAT_GESTIO_ID,
                                       FUNC_ALEATORIO(2) AS ESTAT_GESTIO_ESPAIS_ID       
                                FROM Z_T_SIAP_ACTES NUEVOS 
...
--                                WHERE IDTIPUS_ACTE IS NOT NULL   
   ...
   --QUE EMPIECE EN LA 300
              INSERT INTO CONVIDAT  (ID, TRACTAMENT, NOM, COGNOM1, COGNOM2, TIPUS_CONTACTE, ENTITAT, DEPARTAMENT, CARREC, NOM_CARRER, CODI_CARRER, PIS, PORTA, LLETRA_INICI, LLETRA_FI, ESCALA, BLOC, CODI_POSTAL, COORDENADA_X, COORDENADA_Y, SECCIO_CENSAL, ANY_CONST, NUMERO_INICI, NUMERO_FI, DATA_ENVIAMENT_INVITACIO, ES_CONFIRMA_RECEPCIO_INVITACIO, CODI_ACUS_REBUT, DATA_ACUS_REBUT, DATA_CONFIRMACIO, NOM_PERSONA_DELEGA, CARREC_PERSONA_DELEGA, ENTITAT_PERSONA_DELEGA, OBSERVACIONS, ES_ASSISTIT_ACTE, DATA_ACTUALITZACIO_ASSISTENCIA, CODI_CLASSIFICACIO, NOM_CLASSIFICACIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, CONTACTE_ID, ACTE_ID, CLASSIFICACIO_ID, ESTAT_CONFIRMACIO_ID, TIPUS_VIA_INVITACIO_ID, INICIATIVA_RESPOSTA_ID, TIPUS_VIA_RESPOSTA_ID, PRIORITAT, CODI_MUNICIPI, MUNICIPI, CODI_PROVINCIA, PROVINCIA, CODI_PAIS, PAIS, CODI_TIPUS_VIA, CODI_BARRI, BARRI, CODI_DISTRICTE, DISTRICTE)
               SELECT AUX_SEQ_CONVITAT.NEXTVAL AS ID, 
--                   VIP.N_VIP AS SUBJECTE_ID,
                  ...
                  (CASE WHEN trim(SUBSTR(ORGA.COGNOMS,1, INSTR(LOWER(ORGA.COGNOMS),' i ')-1)) IS NOT NULL THEN 
                   ...
                   ELSE 
                            NULL 
                   END) AS COGNOM2, 
                   (SELECT TIPUS_CONTACTE_ID FROM CONTACTE WHERE ID = CONTACTE.ID) AS TIPUS_CONTACTE,
                   ...
                   ORGA.INC_CONF AS ES_CONFIRMA_RECEPCIO_INVITACIO,
                   ...
                   (CASE WHEN ORGA.INC_CONF='S' THEN
                    ...
                    ELSE
                           0
                   END) AS ES_ASSISTIT_ACTE,
                   ORGA.DAT_CONF2 AS DATA_ACTUALITZACIO_ASSISTENCIA,
                   ORGA.CLASSIF AS CODI_CLASSIFICACIO,
                   (SELECT DESCRIPCIO FROM DM_CLASSIFICACIO WHERE CODI = ORGA.CLASSIF) AS NOM_CLASSIFICACIO,
                   ...
                   (SELECT ID FROM DM_CLASSIFICACIO WHERE CODI=CLASSIF) AS CLASSIFICACIO_ID,
                   2 AS ESTAT_CONFIRMACIO,
                   1 AS TIPUS_VIA_INVITACIO_ID,
                   1 AS INCIATIVA_RESPOSTA_ID,
                   1 AS TIPUS_VIA_RESPOSTA_ID,
                   (SELECT  PRIORITAT_ID FROM SUBJECTE WHERE ID = ORGA.N_VIP) AS PRIORITAT, --ojo si es 0 hay que poner NULL
...
--                   VIP.N_VIP AS SUBJECTE_ID,
  ...
  BEGIN
    ...
    INSERT INTO ACTE (ID, TITOL, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, DATA_ENTRADA, COMENTARIS_VALORACIO, ELEMENT_PRINCIPAL_ID, TIPUS_ACTE_ID, CATEGORIA_ID, SECTOR_ID, PRESIDENT_ID, PETICIONARI_ID, ESTAT_ACTE_ID, ESTAT_GESTIO_INVITACIO_ID, ESTAT_GESTIO_ESPAIS_ID)
                                SELECT CODI AS ID,
                                       NVL(SUBSTR(DESCRIPCIO,1,100),'*') AS TITOL,
                                       FUNC_FECHA_NULA(DATA_INI) AS DATA_CREACIO,
                                       NULL AS  DATA_ESBORRAT, 
                                       NULL AS DATA_MODIFICACIO, 
                                       'MIGRACIO' AS USUARI_CREACIO, 
                                       NULL AS USUARI_ESBORRAT, 
                                       NULL AS USUARI_MODIFICACIO,
                                       FUNC_FECHA_NULA(DATA_INI) AS DATA_ENTRADA,
                                       OBSERVACIONS AS COMENTARIS_VALORACIO,
                                       1 AS ELEMENT_PRINCIPAL_ID,
                                       (SELECT ID FROM DM_TIPUS_ACTE WHERE CODI = NUEVOS.OBSERVACIONS) AS TIPUS_ACTE_ID,
                                       FUNC_ALEATORIO(21)  AS CATEGORIA_ID, --OJO TEMPORAL. NO PERMITE NULOS
                                       FUNC_ALEATORIO(27) AS SECTOR_ID,
                                       FUNC_ALEATORIO(82) AS PRESIDENT_ID,
                                       FUNC_ALEATORIO(147) AS PETICIONARI_ID,
                                       ...
                                       FUNC_ALEATORIO(3) AS ESTAT_GESTIO_ID,
                                       FUNC_ALEATORIO(2) AS ESTAT_GESTIO_ESPAIS_ID       
                                FROM Z_TMP_VIPS_U_ACTES NUEVOS 
                               WHERE NOT EXISTS (SELECT 1 
                                                   FROM ACTE ANTIGUOS
 ...
 PROCEDURE G130_CORREUS_CONVITAT IS
    ...
    BEGIN
        ...
        BEGIN
            ...
            INSERT INTO CONVIDAT_CORREU(ID, CORREU_ELECTRONIC, ES_PRINCIPAL, DATA_CREACIO, USUARI_CREACIO, CONIDAT_ID)
                    SELECT AUX_SEQ_CONVIDAT_CORREU.NEXTVAL AS ID, 
  ...
  BEGIN
    ...
    DELETE FROM AUX_CONVIDAT;
    DELETE FROM AUX_ACTE;
    
    
    
    
  --CATÁLOGO DE SIAP  
    DELETE FROM AUX_DM_ESTAT_GESTIO_ESPAIS;
    DELETE FROM AUX_DM_ESTAT_GESTIO_INVITACIO;
    DELETE FROM AUX_DM_TIPUS_ACTE_2; --TEMPORAL Y COMO AYUDA DE DUPLICADOS
--    DELETE FROM AUX_DM_ESTAT_ACTE;    
    ...
    DELETE FROM AUX_DM_PETICIONARI;
    DELETE FROM AUX_DM_PRESIDENT;

    DELETE FROM AUX_DM_CATEGORIA;    
    DELETE FROM AUX_DM_SECTOR;

    DELETE FROM AUX_DM_TIPUS_ACTE;
    ...
    DELETE FROM AUX_DM_TIPUS_VIA_RESPOSTA;
    DELETE FROM AUX_DM_INICIATIVA_RESPOSTA;
    --CATÁLOGO FIJO  
    DELETE FROM AUX_DM_TIPUS_VIA_INVITACIO;
    --CATÁLOGO FIJO
    DELETE FROM AUX_DM_ESTAT_CONFIRMACIO; 
