--------------------------------------------------------
--  DDL for Package Body A_05_SIAP_ACTES
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."A_05_SIAP_ACTES" AS
  ...
  */
  ...
  BEGIN
              ...
              INSERT INTO Z_G002_NUEVOS_CLASIFFICACIO (ID_SINTAGMA, ID_SIAP, SIAP_CODI, SIAP_CLASSIFICACIO, SIAP_OBSOLET)
                        SELECT (SEQ_DM_CLASSIFICACIO.NEXTVAL) AS ID_SINTAGMA,
...
*/
  ...
  BEGIN
   ...
   SELECT MAX(ID) INTO max_ID_SIAP 
            ...
            SET_SEQ('SEQ_DM_TIPUS_ACTE',max_ID_SIAP);
        ...
        INSERT INTO Z_G021_TIPUS_ACTE_VIPS (ID, CODI, DESCRIPCIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO)
                 SELECT ( max_ID_SIAP + SEQ_DM_TIPUS_ACTE.NEXTVAL) AS ID,
                        CODI AS CODI,
...
*/
  ...
  BEGIN
            ...
            INSERT INTO Z_G045_ESTAT_ACTE (ID,DESCRIPCIO)
                        SELECT SEQ_DM_ESTAT_ACTE.NEXTVAL AS ID,
...
/*
		...
		CREATE table Z_G116_CONVIDAT_PASO2  as
		SELECT NOM, COGNOM1, COGNOM2,func_normalitzar(NOM|| COGNOM1|| COGNOM2) AS nom_normalitzat, CODI_CLASSIFICACIO, CONTACTE_ID
		FROM Z_G115_CONVIDAT_PASO1
		GROUP by NOM, COGNOM1, COGNOM2, func_normalitzar(NOM|| COGNOM1|| COGNOM2), CODI_CLASSIFICACIO, CONTACTE_ID
        
*/        


  PROCEDURE Z_G116_CONVIDAT_PASO2 IS 
  BEGIN
    INSERT INTO Z_G116_CONVIDAT_PASO2
        SELECT NOM, COGNOM1, COGNOM2,func_normalitzar(NOM|| COGNOM1|| COGNOM2) AS nom_normalitzat, CODI_CLASSIFICACIO, CONTACTE_ID
            FROM Z_G115_CONVIDAT_PASO1
            GROUP by NOM, COGNOM1, COGNOM2, func_normalitzar(NOM|| COGNOM1|| COGNOM2), CODI_CLASSIFICACIO, CONTACTE_ID
  ...
  PROCEDURE Z_G117_CONVIDAT_PASO3 IS
  BEGIN
  
              INSERT INTO Z_G117_CONVIDAT_PASO3
               SELECT ID, TRACTAMENT, ORIG.NOM, ORIG.COGNOM1, ORIG.COGNOM2, TIPUS_CONTACTE, ENTITAT, DEPARTAMENT, CARREC, NOM_CARRER, CODI_CARRER, PIS, PORTA, LLETRA_INICI, LLETRA_FI, ESCALA, BLOC, CODI_POSTAL, COORDENADA_X, COORDENADA_Y, SECCIO_CENSAL, ANY_CONST, NUMERO_INICI, NUMERO_FI, DATA_ENVIAMENT_INVITACIO, ES_CONFIRMA_RECEPCIO_INVITACIO, CODI_ACUS_REBUT, DATA_ACUS_REBUT, DATA_CONFIRMACIO, NOM_PERSONA_DELEGA, CARREC_PERSONA_DELEGA, ENTITAT_PERSONA_DELEGA, OBSERVACIONS, DATA_ACTUALITZACIO_ASSISTENCIA, ORIG.CODI_CLASSIFICACIO, NOM_CLASSIFICACIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, ORIG.CONTACTE_ID, ACTE_ID, ESTAT_CONFIRMACIO_ID, TIPUS_VIA_INVITACIO_ID, INICIATIVA_RESPOSTA_ID, TIPUS_VIA_RESPOSTA_ID, PRIORITAT, CODI_MUNICIPI, MUNICIPI, CODI_PROVINCIA, PROVINCIA, CODI_PAIS, PAIS, CODI_TIPUS_VIA, CODI_BARRI, BARRI, CODI_DISTRICTE, DISTRICTE,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,DECISIO_ASSISTENCIA_ID,
                       ROW_NUMBER ()  OVER (PARTITION BY  func_normalitzar(orig.NOM|| orig.COGNOM1|| orig.COGNOM2) ORDER BY  func_normalitzar(orig.NOM|| orig.COGNOM1|| orig.COGNOM2) ASC ) AS COLNUM
               FROM Z_G115_CONVIDAT_PASO1 ORIG,
                    Z_G116_CONVIDAT_PASO2 UNIC
               WHERE func_normalitzar(orig.NOM|| orig.COGNOM1|| orig.COGNOM2) =  unic.nom_normalitzat
                 AND ORIG.CODI_CLASSIFICACIO=UNIC.CODI_CLASSIFICACIO
                 AND ORIG.CONTACTE_ID=UNIC.CONTACTE_ID     
                 ORDER BY orig.NOM|| orig.COGNOM1|| orig.COGNOM2
  
  COMMIT;
  END;


  PROCEDURE Z_G118_CONVIDAT_FINAL IS
  BEGIN
  
              INSERT INTO Z_G118_CONVIDAT_FINAL     
               SELECT ID, TRACTAMENT, NOM, COGNOM1, COGNOM2, TIPUS_CONTACTE, ENTITAT, DEPARTAMENT, CARREC, NOM_CARRER, CODI_CARRER, PIS, PORTA, LLETRA_INICI, LLETRA_FI, ESCALA, BLOC, CODI_POSTAL, COORDENADA_X, COORDENADA_Y, SECCIO_CENSAL, ANY_CONST, NUMERO_INICI, NUMERO_FI, DATA_ENVIAMENT_INVITACIO, ES_CONFIRMA_RECEPCIO_INVITACIO, CODI_ACUS_REBUT, DATA_ACUS_REBUT, DATA_CONFIRMACIO, NOM_PERSONA_DELEGA, CARREC_PERSONA_DELEGA, ENTITAT_PERSONA_DELEGA, OBSERVACIONS, DATA_ACTUALITZACIO_ASSISTENCIA, CODI_CLASSIFICACIO, NOM_CLASSIFICACIO, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, CONTACTE_ID, ACTE_ID, ESTAT_CONFIRMACIO_ID, TIPUS_VIA_INVITACIO_ID, INICIATIVA_RESPOSTA_ID, TIPUS_VIA_RESPOSTA_ID, PRIORITAT, CODI_MUNICIPI, MUNICIPI, CODI_PROVINCIA, PROVINCIA, CODI_PAIS, PAIS, CODI_TIPUS_VIA, CODI_BARRI, BARRI, CODI_DISTRICTE, DISTRICTE,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL,DECISIO_ASSISTENCIA_ID
               FROM Z_G117_CONVIDAT_PASO3
               WHERE COLNUM=1    
