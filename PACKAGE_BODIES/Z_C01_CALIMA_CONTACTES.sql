--------------------------------------------------------
--  DDL for Package Body Z_C01_CALIMA_CONTACTES
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."Z_C01_CALIMA_CONTACTES" AS

PROCEDURE C00_TABLAS_ESENCIALES IS
BEGIN

            Insert into A0_DM_ESTAT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,CODI) values ('2','Passada',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,null,'PASSADA');
            Insert into A0_DM_ESTAT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,CODI) values ('3','Prevista',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,null,'PREVISTA');
            Insert into A0_DM_ESTAT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,CODI) values ('1','Pendent',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,null,'PENDENT');
