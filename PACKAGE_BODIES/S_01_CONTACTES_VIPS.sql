--------------------------------------------------------
--  DDL for Package Body S_01_CONTACTES_VIPS
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."S_01_CONTACTES_VIPS" AS
    ...
    BEGIN              
        ...
        SELECT A1_SEQ_CONTACTE.NEXTVAL AS ID_CONTACTE, 
                   N_VIP, 
...
--         max_seq := max_seq +1;
--         SET_SEQ('A1_SEQ_DM_TRACTAMENT',max_seq);
/*            
            INSERT INTO Z_SB030_TRACTAMENT (ID, CODI, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO,USUARI_ESBORRAT, USUARI_MODIFICACIO, ABREUJADA,ID_ORIGINAL,ESQUEMA_ORIGINAL,TABLA_ORIGINAL) 
                         SELECT A1_SEQ_DM_TRACTAMENT.NEXTVAL AS ID , 
...
--                                          WHERE ANTIGUOS.DESCRIPCIO = NUEVOS.DESCRIPCIO);
    ...
    COMMIT;
                INSERT INTO A1_DM_TRACTAMENT (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, ABREUJADA,ID_ORIGINAL,ESQUEMA_ORIGINAL,TABLA_ORIGINAL) 
                     SELECT ID, 
                     		DESCRIPCIO, 
                     		DATA_CREACIO, 
                     		DATA_MODIFICACIO, 
    ...
    BEGIN
            ...
            INSERT INTO Z_SB050_CARRECS (ID_CARREC,CARREC_NORM,ID_ORIGINAL,ESQUEMA_ORIGINAL,TABLA_ORIGINAL)
                   SELECT A1_SEQ_DM_CARREC.NEXTVAL AS ID_CARREC, 
...
--                                  (SELECT tractament.ID FROM A1_DM_TRACTAMENT tractament WHERE tractament.ID_ORIGINAL = Subjecte.Tractament) AS TRACTAMENT_ID,
                                  (CASE WHEN (SELECT Tractament.ID FROM A1_DM_TRACTAMENT Tractament WHERE Tractament.ID_ORIGINAL = Subjecte.TRACTAMENT ) IS NULL THEN
                                            (SELECT ID
                                            FROM A1_DM_TRACTAMENT
                                  ...
                                  ELSE                                                                          
                                             (SELECT Tractament.ID FROM A1_DM_TRACTAMENT Tractament WHERE Tractament.ID_ORIGINAL = Subjecte.TRACTAMENT)
    ...
    INSERT INTO Z_SB073_SUBJECTE_CONTACTE (ID, NOM,COGNOM1,COGNOM2,ALIES,NOM_NORMALITZAT,DATA_DEFUNCIO,MOTIU_BAIXA,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TRACTAMENT_ID,	PRIORITAT_ID, TIPUS_SUBJECTE_ID, AMBIT_ID, IDIOMA_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                ...
                FROM (
                          SELECT  Contactes.N_VIP AS ID,
                                  ...
                                  (CASE WHEN (SELECT Tractament.ID FROM A1_DM_TRACTAMENT Tractament WHERE Tractament.ID_ORIGINAL = VIPS.TRACTAMENT ) IS NULL THEN
                                            (SELECT ID
                                            FROM A1_DM_TRACTAMENT
                                            WHERE FUNC_NORMALITZAR_TRACTAMENT(DESCRIPCIO) = (
                                                                                              SELECT FUNC_NORMALITZAR_TRACTAMENT(DESCRIPCIO)
                                  ...
                                  ELSE                                                                          
                                             (SELECT Tractament.ID FROM A1_DM_TRACTAMENT Tractament WHERE Tractament.ID_ORIGINAL = VIPS.TRACTAMENT)
                                  END)AS TRACTAMENT_ID, 
--                                  (SELECT Prioritat.ID FROM DM_PRIORITAT Prioritat WHERE Prioritat.DESCRIPCIO = SubjectePR.prioritat) AS PRIORITAT_ID,
    ...
    BEGIN
      ...
      INSERT INTO Z_SB999_SUBJECTE (ID, NOM, COGNOM1, COGNOM2, ALIES, DATA_DEFUNCIO, NOM_NORMALITZAT, MOTIU_BAIXA, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, TRACTAMENT_ID, PRIORITAT_ID, TIPUS_SUBJECTE_ID, AMBIT_ID, IDIOMA_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL , TABLA_ORIGINAL)      
       ...
       COMMIT;                                 
        ...
        INSERT INTO A1_SUBJECTE (ID, NOM, COGNOM1, COGNOM2, ALIES, DATA_DEFUNCIO, NOM_NORMALITZAT, MOTIU_BAIXA, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, TRACTAMENT_ID, PRIORITAT_ID, TIPUS_SUBJECTE_ID, AMBIT_ID, IDIOMA_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL , TABLA_ORIGINAL)
                SELECT  ID AS ID,
                        NOM AS NOM,
                        COGNOM1 AS COGNOM1,
                        COGNOM2 AS COGNOM2,
    ...
    BEGIN
     ...
     COMMIT;
              INSERT INTO A1_ADRECA (ID, NOM_CARRER, MUNICIPI, PROVINCIA, CODI_POSTAL, PAIS, USUARI_CREACIO, DATA_CREACIO, USUARI_MODIFICACIO,DATA_MODIFICACIO,ID_ORIGINAL, ESQUEMA_ORIGINAL , TABLA_ORIGINAL)
                 SELECT ID, 
                        NOM_CARRER, 
                        MUNICIPI, 
                        PROVINCIA, 
...
--                AND TO_NUMBER(SUBSTR(PAIS,1,1)) IN (0,1,2,3) AND TRIM(PAIS)<>'.'
    ...
    BEGIN
       ...
       INSERT INTO A1_CONTACTE (ID, ES_PRINCIPAL, CARREC_ID, DEPARTAMENT, DADES_QUALITAT, DATA_DARRERA_ACTUALITZACIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TIPUS_CONTACTE_ID, SUBJECTE_ID, ADRECA_ID, ENTITAT_ID,VISIBILITAT_ID, AMBIT_ID,ID_ORIGINAL, ESQUEMA_ORIGINAL , TABLA_ORIGINAL) 
          SELECT ID AS ID, 
                 ES_PRINCIPAL, 
                 CARREC_ID, 
                 DEPARTAMENT, 
    ...
    BEGIN
        ...
        BEGIN
            ...
            INSERT INTO A1_CONTACTE_CORREU(ID, CORREU_ELECTRONIC, ES_PRINCIPAL, DATA_CREACIO, USUARI_CREACIO, Contacte_Id,ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                    SELECT A1_SEQ_CONTACTE_CORREU.NEXTVAL AS ID, 
                     ...
                     WHERE NOT EXISTS(SELECT 1 
                                      FROM A1_CONTACTE_CORREU correu
                                      WHERE correu.Contacte_Id = cc.id_contacte
                                        AND CORREU_ELECTRONIC = CC.CORREU)
                      and exists (select 1 from a1_contacte contacte
...
*/    
    ...
    BEGIN
          ...
          INSERT INTO Z_SB120_CLASSIFICACIONS (ID, CODI, DESCRIPCIO, ORDEN, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                SELECT A1_SEQ_DM_CLASSIFICACIO.NEXTVAL AS ID,
                       CLASSIF.CODI, 
                       CLASSIF.DESCRIPCIO, 
                       LISTA.orden,
...
--                       (case when (select  CODI from TMP_CLASSIF_ACTIVES) is null NULL AS DATA_ESBORRAT,
    ...
    BEGIN
    /*
        INSERT INTO A1_CONTACTE_CLASSIFICACIO (ID, PRELACIO, DATA_FI_VIGENCIA, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, CLASSIFICACIO_ID, CONTACTE_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
              SELECT A1_SEQ_CONTACTE_CLASSIFICACIO.NEXTVAL AS ID, 
              ...
              WHERE NOT EXISTS(SELECT 1 
                             FROM A1_CONTACTE_CLASSIFICACIO ANTIGUOS 
    ...
    */
        ...
        INSERT INTO Z_SB140_ACOMPANYANTS_VIPS (SUBJECTE_ID, NOM, COGNOM1, COGNOM2, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, TRACTAMENT_ID, CONTACTE_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                       ...
                       SELECT SUBJECTE.ID AS SUBJECTE_ID,
                             ...
                             (CASE WHEN trim(SUBSTR(VIPS.COGNOMS_A,1, INSTR(LOWER(VIPS.COGNOMS_A),' i ')-1)) IS NOT NULL THEN 
                              ...
                              (SELECT Tractament.ID FROM A1_DM_TRACTAMENT Tractament WHERE Tractament.ID_ORIGINAL = VIPS.TRACTAMENT_A ) AS TRACTAMENT_ID, 
    ...
    BEGIN
          ...
          INSERT INTO A1_ACOMPANYANT (ID, NOM, COGNOM1, COGNOM2, DATA_CREACIO, DATA_ESBORRAT, DATA_MODIFICACIO, USUARI_CREACIO, USUARI_ESBORRAT, USUARI_MODIFICACIO, TRACTAMENT_ID, CONTACTE_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
              SELECT A1_SEQ_ACOMPANYANT.NEXTVAL AS ID, 
                     NOM, 
    ...
    BEGIN    
      ...
      DELETE FROM A1_ACOMPANYANT;
      DELETE FROM A1_CONTACTE_CLASSIFICACIO;
      DELETE FROM A1_DM_CLASSIFICACIO;
      DELETE FROM A1_CONTACTE_TELEFON;
      DELETE FROM A1_CONTACTE_CORREU;
      DELETE FROM A1_CONTACTE;
      DELETE FROM A1_ADRECA;
      DELETE FROM A1_SUBJECTE;
      DELETE FROM A1_DM_ENTITAT;
      DELETE FROM A1_DM_CARREC;
      DELETE FROM A1_DM_TRACTAMENT;	  
    ...
    BEGIN
        ...
        --DROP SEQUENCE A1_SEQ_xxx;
        --CREATE SEQUENCE A1_SEQ_xxx MINVALUE 10000 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 10000 NOCACHE NOORDER NOCYCLE;
        FOR i in 1 .. total LOOP
            -- NOMBRE : A1_SEQ_DM_XXX        Nímero al cuál resetear
