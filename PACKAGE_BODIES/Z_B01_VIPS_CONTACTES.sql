--------------------------------------------------------
--  DDL for Package Body Z_B01_VIPS_CONTACTES
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."Z_B01_VIPS_CONTACTES" AS
    ...
    BEGIN              
        ...
        SELECT AUX_SEQ_CONTACTE.NEXTVAL AS ID_CONTACTE, 
                   N_VIP, 
   ...
   PROCEDURE B30_TRACTAMENTS IS 
            ...
            INSERT INTO Z_B030_TRACTAMENT (ID, CODI, DESCRIPCIO, ABREUJADA, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_BAIXA)                                                                      
                         SELECT A0_SEQ_DM_TRACTAMENT.NEXTVAL, 
                                t.CODI, 
    ...
    BEGIN
            ...
            INSERT INTO Z_B060_ENTITAT_CATALOG (ID, CODI, ENTITAT, ENTITAT_NORM)
                 SELECT A0_SEQ_DM_ENTITAT.NEXTVAL, 
                        CODI, 
                        ENTITAT, 
                        ENTITAT_NORM
                   FROM (
                  ...
                  FROM (
                          SELECT  Subjecte.N_VIP AS ID,
                                  ...
                                  (SELECT tractament.ID FROM A0_DM_TRACTAMENT tractament WHERE tractament.ID = Subjecte.Tractament) AS TRACTAMENT_ID,
                                   (SELECT 1 FROM Z_B071_SUBJECTES_AMB_PRIORITAT WHERE n_vip = Subjecte.N_VIP) AS PRIORITAT_ID,
                          ...
                          WHERE Subjecte.N_VIP = SubjecteDifunto.N_VIP (+)                             
                            AND NOT EXISTS (SELECT 1 
                                            FROM Z_B072_SUBJECTES_VIPS ANTIGUOS
    ...
    INSERT INTO Z_B073_SUBJECTE_CONTACTE (ID, NOM,COGNOM1,COGNOM2,ALIES,NOM_NORMALITZAT,DATA_DEFUNCIO,MOTIU_BAIXA,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO, USUARI_MODIFICACIO, USUARI_ESBORRAT, TRACTAMENT_ID,	PRIORITAT_ID, TIPUS_SUBJECTE_ID, AMBIT_ID, IDIOMA_ID)
                ...
                FROM (
                          SELECT  Contactes.N_VIP AS ID,
                                  ...
                                  (SELECT Tractament.ID FROM Z_B030_TRACTAMENT Tractament WHERE Tractament.CODI = VIPS.TRACTAMENT ) AS TRACTAMENT_ID, 
                                  (SELECT 1 FROM Z_B071_SUBJECTES_AMB_PRIORITAT WHERE n_vip = SubjectePR.N_VIP) AS PRIORITAT_ID,
                                  ConstSubjectePersona AS TIPUS_SUBJECTE_ID,
                                  ConstAMBIT_PROTOCOL AS AMBIT_ID,
                                  NULL AS IDIOMA_ID 
              ...
              WHERE NOT EXISTS (SELECT 1 
                                FROM Z_B073_SUBJECTE_CONTACTE ANTIGUOS 
...
--                AND TO_NUMBER(SUBSTR(PAIS,1,1)) IN (0,1,2,3) AND TRIM(PAIS)<>'.'
    ...
    PROCEDURE B110_TELEFON1 IS
    BEGIN
            INSERT INTO Z_SB110_TELEFON (ID_CONTACTE, N_VIP, TIPUS_TELEFON, TELEFON, ES_PRINCIPAL, CONCEPTE, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                SELECT NUEVOS.ID_CONTACTE, 
                       ...
                       ES_PARTICULAR AS ES_PARTICULAR,
                ...
                FROM (	   
                       SELECT DISTINCT ID_CONTACTE As ID_CONTACTE,
                              ...
                              FCN_NORMALITZAR_TFN_CONCEPTO(TELEFON1) AS CONCEPTE
            ...
            INSERT INTO Z_SB110_TELEFON (ID_CONTACTE, N_VIP, TIPUS_TELEFON, TELEFON, ES_PRINCIPAL, CONCEPTE, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                ...
                FROM (	   
                       SELECT DISTINCT ID_CONTACTE As ID_CONTACTE,
                              ...
                              FCN_NORMALITZAR_TFN_CONCEPTO(TELEFON2) AS CONCEPTE
                       FROM Z_SB003_CONTACTES_ID C
    ...
    PROCEDURE B112_TELEFON_MOBIL IS
    BEGIN
        ...
        INSERT INTO Z_SB110_TELEFON (ID_CONTACTE, N_VIP, TIPUS_TELEFON, TELEFON, ES_PRINCIPAL, CONCEPTE, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                ...
                FROM (	   
                       SELECT DISTINCT ID_CONTACTE As ID_CONTACTE,
                              ...
                              FCN_NORMALITZAR_TFN_CONCEPTO(TELEFON_MOBIL) AS CONCEPTE
                       FROM Z_SB003_CONTACTES_ID C
         ...
         INSERT INTO Z_SB110_TELEFON (ID_CONTACTE, N_VIP, TIPUS_TELEFON, TELEFON, ES_PRINCIPAL, CONCEPTE, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)
                ...
                FROM (	   
                             ...
                             SELECT DISTINCT ID_CONTACTE,
                                    ...
                                    FCN_NORMALITZAR_TFN_CONCEPTO(FAX) AS CONCEPTE
                             FROM Z_B003_CONTACTES_ID C
    ...
    BEGIN
          ...
          INSERT INTO Z_B120_CLASSIFICACIONS 
                SELECT A0_SEQ_DM_CLASSIFICACIO.NEXTVAL,
                       cl.CODI, 
                       cl.DESCRIPCIO, 
                       p.orden
    ...
    BEGIN
      ...
      INSERT INTO A0_CONTACTE_CLASSIFICACIO (ID, PRELACIO, CLASSIFICACIO_ID, CONTACTE_ID, DATA_CREACIO, USUARI_CREACIO , USUARI_MODIFICACIO, DATA_MODIFICACIO)
              SELECT A0_SEQ_CONTACTE_CLASSIF.NEXTVAL, 
                     NUEVOS.n_prelacio, 
    ...
    BEGIN
        ...
        Secuencia := V_Sequence('A0_SEQ_CONTACTE_VIPS',
                                'A0_SEQ_CONTACTE_CORREU_VIPS',
                                'A0_SEQ_ACOMPANYANT_VIPS',
                                'A0_SEQ_DM_TRACTAMENT_VIPS',
                                'A0_SEQ_CONTACTE_TELEFON_VIPS',
                                'A0_SEQ_DM_CARREC_VIPS',
                                'A0_SEQ_DM_ENTITAT_VIPS',
                                'A0_SEQ_ADRECA_VIPS',
                                'A0_SEQ_DM_CLASSIFICACIO_VIPS',
                                'A0_SEQ_CONTACTE_CLASSIF_VIPS');
...
DROP SEQUENCE A0_SEQ_CONTACTE;
CREATE SEQUENCE A0_SEQ_CONTACTE MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_CONTACTE_CORREU;
CREATE SEQUENCE A0_SEQ_CONTACTE_CORREU MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_ACOMPANYANT;
CREATE SEQUENCE A0_SEQ_ACOMPANYANT MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_DM_TRACTAMENT;
CREATE SEQUENCE A0_SEQ_DM_TRACTAMENT MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_CONTACTE_TELEFON;
CREATE SEQUENCE A0_SEQ_CONTACTE_TELEFON MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_DM_CARREC;
CREATE SEQUENCE A0_SEQ_DM_CARREC MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;


DROP SEQUENCE A0_SEQ_DM_ENTITAT;
CREATE SEQUENCE A0_SEQ_DM_ENTITAT MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;


DROP SEQUENCE A0_SEQ_ADRECA;
CREATE SEQUENCE A0_SEQ_ADRECA MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_DM_CLASSIFICACIO;
CREATE SEQUENCE A0_SEQ_DM_CLASSIFICACIO MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_CONTACTE_CLASSIF;
CREATE SEQUENCE A0_SEQ_CONTACTE_CLASSIF MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_SUBJECTE;
CREATE SEQUENCE A0_SEQ_SUBJECTE MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

DROP SEQUENCE A0_SEQ_DM_DESTINATARI_PERSONA;
CREATE SEQUENCE A0_SEQ_DM_DESTINATARI_PERSONA MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;
...
Insert into A0_DM_SENTIT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO) values ('2','ENTRADA',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MME',null,null);
Insert into A0_DM_SENTIT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO) values ('1','SORTIDA',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MME',null,null);

Insert into A0_DM_ESTAT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,CODI) values ('2','PASSADA',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MME',null,null,'PASSADA');
Insert into A0_DM_ESTAT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,CODI) values ('3','PREVISTA',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MME',null,null,'PREVISTA');
Insert into A0_DM_ESTAT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,CODI) values ('1','PENDENT',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MME',null,null,'PENDENT');
