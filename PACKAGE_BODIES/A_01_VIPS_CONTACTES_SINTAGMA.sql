--------------------------------------------------------
--  DDL for Package Body A_01_VIPS_CONTACTES_SINTAGMA
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "SINTAGMA_U"."A_01_VIPS_CONTACTES_SINTAGMA" AS
...
------------------------------------------------------------------------------    
    ...
    BEGIN
           INSERT INTO Z_B071_SUBJECTES_AMB_PRIORITAT    (N_VIP, PRIORITAT)
                SELECT N_VIP, 
                       REPLACE(TRIM(FAX), '91-SC','S.C.') AS PRIORITAT
                FROM Z_B003_CONTACTES_ID 
                WHERE TRIM(FAX) IN ('1-SC','91-SC')        
                  AND NOT EXISTS(SELECT 1
                            FROM Z_B071_SUBJECTES_AMB_PRIORITAT ANTIGUOS
                            WHERE ANTIGUOS.N_VIP = N_VIP)
                GROUP BY N_VIP, REPLACE(TRIM(FAX),'91-SC','S.C.') ;
...
--                AND TO_NUMBER(SUBSTR(PAIS,1,1)) IN (0,1,2,3) AND TRIM(PAIS)<>'.'
    ...
    BEGIN
        ...
        Secuencia := V_Sequence('SEQ_CONTACTE_VIPS',
                                'SEQ_CONTACTE_CORREU_VIPS',
                                'SEQ_ACOMPANYANT_VIPS',
                                'SEQ_DM_TRACTAMENT_VIPS',
                                'SEQ_CONTACTE_TELEFON_VIPS',
                                'SEQ_DM_CARREC_VIPS',
                                'SEQ_DM_ENTITAT_VIPS',
                                'SEQ_ADRECA_VIPS',
                                'SEQ_DM_CLASSIFICACIO_VIPS',
                                'SEQ_CONTACTE_CLASSIF_VIPS');
...
Insert into A0_DM_SENTIT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO) values ('2','ENTRADA',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,null);
Insert into A0_DM_SENTIT_TRUCADA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO) values ('1','SORTIDA',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,null);
...
Insert into A0_DM_AFECTA_AGENDA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,AMBIT_ID) values ('0','NO',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,NULL,1);
Insert into A0_DM_AFECTA_AGENDA (ID,DESCRIPCIO,DATA_CREACIO,DATA_ESBORRAT,DATA_MODIFICACIO,USUARI_CREACIO,USUARI_ESBORRAT,USUARI_MODIFICACIO,AMBIT_ID) values ('1','SÍ',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,NULL,1);
...
INSERT INTO A0_DM_TIPUS_AMBIT (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARIO_ESBORRAT, AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL)VALUES(1, 'TIPO ALCALDIA',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,NULL,1, '', '', '');

INSERT INTO SINTAGMA_U.A0_DM_BARRI (ID, DESCRIPCIO, DATA_CREACIO, DATA_MODIFICACIO, DATA_ESBORRAT, USUARI_CREACIO, USUARI_MODIFICACIO, USUARIO_ESBORRAT, AMBIT_ID, ID_ORIGINAL, ESQUEMA_ORIGINAL, TABLA_ORIGINAL) VALUES(0, 'SENSE DEFINIR',to_timestamp(Sysdate,'DD/MM/RRRR HH24:MI:SS'),null,null,'MIGRACIO',null,NULL,1, '', '', '');
