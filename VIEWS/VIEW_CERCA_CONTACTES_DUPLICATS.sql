--------------------------------------------------------
--  DDL for View VIEW_CERCA_CONTACTES_DUPLICATS
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SINTAGMA_U"."VIEW_CERCA_CONTACTES_DUPLICATS" ("RESULT_ID", "RESULT_NOM_SUBJECTE", "RESULT_COGNOM1_SUBJECTE", "RESULT_COGNOM2_SUBJECTE", "RESULT_ENTITAT_ID", "RESULT_ENTITAT", "RESULT_DEPARTAMENT", "RESULT_CARREC", "RESULT_TIPUS_VIA", "RESULT_NOM_CARRER", "RESULT_NUMERO_INICI", "RESULT_NUMERO_FI", "RESULT_ESCALA", "RESULT_PIS", "RESULT_PORTA", "RESULT_BARRI", "RESULT_DISTRICTE", "RESULT_MUNICIPI", "RESULT_CODI_POSTAL", "RESULT_PROVINCIA", "RESULT_PAIS", "RESULT_NUMERO_PRINCIPAL", "RESULT_CORREU_PRINCIPAL", "RESULT_ES_PRINCIPAL", "FILTER_NOM_SUBJECTE", "FILTER_COGNOM1_SUBJECTE", "FILTER_COGNOM2_SUBJECTE", "FILTER_ENTITAT", "FILTER_DEPARTAMENT", "FILTER_CARREC", "FILTER_AMBIT_ID") AS 
  SELECT
          ...
          con.es_principal AS result_es_principal,
          ...
          vent.ID AS filter_entitat, con.departament AS filter_departament,
          vcarr.ID AS filter_carrec, amb.ID AS filter_ambit_id
    ...
    WHERE con.data_esborrat IS NULL AND tipuscon.codi = 'PROFESSIONAL' 
;
