--------------------------------------------------------
--  DDL for Package S_03_CONTACTES_RISPLUS
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE "SINTAGMA_U"."S_03_CONTACTES_RISPLUS" AS 
...
--    PROCEDURE ERROR_SUBJECTES_NULL;
   ...
   PROCEDURE SD070_TELEFONS_FIXE_SPLIT;
