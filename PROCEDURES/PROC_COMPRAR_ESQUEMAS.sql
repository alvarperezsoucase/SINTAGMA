--------------------------------------------------------
--  DDL for Procedure PROC_COMPRAR_ESQUEMAS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SINTAGMA_U"."PROC_COMPRAR_ESQUEMAS" IS 
--            TYPE V_TablasSINTAGMA IS VARRAY(200) OF VARCHAR2(30);
--             TablasSINTAGMA V_TablasSINTAGMA;
